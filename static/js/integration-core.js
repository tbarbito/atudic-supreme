...
const actionHandlers = {
    ...
    'wsIngestREST': () => wsIngestREST(),
    'wsTestREST': () => wsTestREST(),
    ...
    'wsImpactAnalysis': (params) => wsImpactAnalysis(params),
    'wsExportTable': (params) => wsExportTable(params),
    'wsFonteOverview': (params) => wsFonteOverview(params),
    'wsFonteResumirTodas': (params) => wsFonteResumirTodas(params),
    'wsFonteResumirFuncao': (params) => wsFonteResumirFuncao(params),
    'wsFonteVerCodigo': (params) => wsFonteVerCodigo(params),
    'wsAnotar': (params) => wsAnotar(params),
